function [] = imdif_bootstrap_run_importance_sampler_tacc(bootstrap_num,bootstrap_run)
...
data_dir = '/work/03034/twang04/lonestar/P-CIT/';

%%% VARIABLES THAT CHANGE %%%%
analysis_id = '170811a_test';
group = 'full_N19';
%trial = 'F';
%time = '10to18sec';
trstart = '1';
...
analysis_settings.target_dir = '/work/03034/twang04/lonestar/P-CIT/bootstrap_results';
...
analysis_settings.bootstrap_run = bootstrap_run; %added this as to do different bootstrap run numbers (e.g. bootstrap 405 out of 1000)
...
start_dir = pwd;
  ...
  data_file = fullfile(data_dir, sprintf('/data/imdif_pcit_data_9TRS_%s_net_%s.mat',condition,target));
  load(data_file);
  original_data = data;
